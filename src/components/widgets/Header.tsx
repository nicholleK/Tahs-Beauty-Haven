...
const Header = () => {
  ...
  return (
    <header
      className={`top-0 z-40 mx-auto w-full flex-none bg-[#3B0270]/20 transition-all duration-100 ease-in dark:bg-slate-900/30 md:bg-[#3B0270]/20 backdrop-blur-md dark:md:bg-slate-900/90 dark:backdrop-blur-md ${
                  ...
                  {links && links.length ? (
                    <>
                      ...
                      <ul
                        ...
                        } rounded pl-4 font-medium drop-shadow-xl md:absolute md:min-w-[200px] md:bg-white/95 md:pl-0 md:backdrop-blur-md dark:md:bg-slate-900/90 md:border md:border-gray-200 md:dark:border-slate-700`}
                      >
